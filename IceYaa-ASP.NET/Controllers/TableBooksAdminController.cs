...
{
    public class TableBooksAdminController : Controller
    {
        ...
        // GET: TableBooksAdmin/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TableBooksAdmin/Create
